...
const DonarSignIn = () => {
    ...
    const gotoDonarSignup = () => {
        navigate('/donarSignUp')
    }
                        ...
                        <div className="row align-items-center">
                            <div className="header-text mb-4 mt-5 d-flex flex-column justify-content-center align-items-center">
                                <div className='d-flex justify-content-space-between align-items-center'>
                                    <h2 style={{ fontFamily: 'Poppins', fontWeight: 600 }} className="m-3">Blood Donar</h2>
                                    <img src={dlogo} className="img-fluid" style={{ width: '50px' }} alt="Featured" />
                                </div>
                                <p style={{ fontFamily: 'Poppins', fontWeight: 400 }}>Donate Blood. Login to continue.</p>
                            </div>
                            ...
                            <div>
                                <p>New user ? <button className='btn btn-primary' onClick={gotoDonarSignup}>Signup</button></p>
                            </div>
                            <div className="input-group mb-3">
                                <button className="btn btn-lg btn-primary w-100 fs-6" onClick={loginDonar}>Login</button>
                            </div>
                        </div>
                    </div>
                </div>
